...
from views.insumos_recetas.baseinsrec import BaseInsRecView

#Clase para mostrar los proveedores
class ShowInsRecView(BaseInsRecView):
    def __init__(self, parent, controller):
        ...
        self.headers = ['Id Receta', 'Id Insumo', 'Cantidad']
    ...
    def onShow(self):
        ...
        insrec = self.controller.showInsRec()

        #Bucle para agregar todos los datos obtenidos en pantalla
        for row, tupla in enumerate(insrec, start=2):
